...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style( 'mrwoocommerce-styles', get_template_directory_uri() . $theme_styles, array(), $css_version );
		...
		wp_enqueue_script( 'mrwoocommerce-scripts', get_template_directory_uri() . $theme_scripts, array(), $js_version, true );
...
if ( ! function_exists( 'understrap_offcanvas_admin_bar_inline_styles' ) ) {
	...
	function understrap_offcanvas_admin_bar_inline_styles() {
		...
		wp_add_inline_style( 'mrwoocommerce-styles', $css );
	}
}
