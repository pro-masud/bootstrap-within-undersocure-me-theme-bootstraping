	...
	function understrap_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => _x( '&laquo;', 'previous set of posts', 'mrwoocommerce' ),
				'next_text'          => _x( '&raquo;', 'next set of posts', 'mrwoocommerce' ),
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'mrwoocommerce' ),
			)
		);
