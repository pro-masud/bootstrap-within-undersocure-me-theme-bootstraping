...
if ( ! function_exists( 'understrap_theme_customize_register' ) ) {
	...
	function understrap_theme_customize_register( $wp_customize ) {
		...
		$wp_customize->add_section(
			...
			array(
				'title'       => __( 'Theme Layout Settings', 'mrwoocommerce' ),
				'capability'  => 'edit_theme_options',
				'description' => __( 'Container width and sidebar defaults', 'mrwoocommerce' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'understrap_bootstrap_version',
				array(
					'label'       => __( 'Bootstrap Version', 'mrwoocommerce' ),
					'description' => __( 'Choose between Bootstrap 4 and Bootstrap 5', 'mrwoocommerce' ),
					'section'     => 'understrap_theme_layout_options',
					'type'        => 'select',
					'choices'     => array(
						'bootstrap4' => __( 'Bootstrap 4', 'mrwoocommerce' ),
						'bootstrap5' => __( 'Bootstrap 5', 'mrwoocommerce' ),
					),
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'understrap_container_type',
				array(
					'label'       => __( 'Container Width', 'mrwoocommerce' ),
					'description' => __( 'Choose between Bootstrap\'s container and container-fluid', 'mrwoocommerce' ),
					'section'     => 'understrap_theme_layout_options',
					'type'        => 'select',
					'choices'     => array(
						'container'       => __( 'Fixed width container', 'mrwoocommerce' ),
						'container-fluid' => __( 'Full width container', 'mrwoocommerce' ),
					),
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'understrap_navbar_type',
				array(
					'label'       => __( 'Responsive Navigation Type', 'mrwoocommerce' ),
					'description' => __(
					...
					'type'        => 'select',
					'choices'     => array(
						'collapse'  => __( 'Collapse', 'mrwoocommerce' ),
						'offcanvas' => __( 'Offcanvas', 'mrwoocommerce' ),
					),
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'understrap_sidebar_position',
				array(
					'label'       => __( 'Sidebar Positioning', 'mrwoocommerce' ),
					'description' => __(
					...
					'type'        => 'select',
					'choices'     => array(
						'right' => __( 'Right sidebar', 'mrwoocommerce' ),
						'left'  => __( 'Left sidebar', 'mrwoocommerce' ),
						'both'  => __( 'Left & Right sidebars', 'mrwoocommerce' ),
						'none'  => __( 'No sidebar', 'mrwoocommerce' ),
					),
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'understrap_site_info_override',
				array(
					'label'       => __( 'Footer Site Info', 'mrwoocommerce' ),
					'description' => __( 'Override Understrap\'s site info located at the footer of the page.', 'mrwoocommerce' ),
					'section'     => 'understrap_theme_layout_options',
					'type'        => 'textarea',
					'priority'    => 20,
				)
