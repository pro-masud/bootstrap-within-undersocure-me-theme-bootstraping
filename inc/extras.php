...
if ( ! function_exists( 'understrap_body_classes' ) ) {
	...
	function understrap_body_classes( $classes ) {
		...
		if ( is_page_template(
			...
			$classes[] = 'mrwoocommerce-no-sidebar';
		} elseif (
			is_page_template(
				array(
			...
			$classes[] = 'mrwoocommerce-has-sidebar';
...
if ( ! function_exists( 'understrap_all_excerpts_get_more_link' ) ) {
	...
	function understrap_all_excerpts_get_more_link( $post_excerpt ) {
		...
		return $post_excerpt . ' [...]<p><a class="btn btn-secondary mrwoocommerce-read-more-link" href="' . $permalink . '">' . __(
			'Read More...',
			'mrwoocommerce'
