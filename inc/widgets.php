	...
	function understrap_widgets_init() {
		register_sidebar(
			array(
				...
				'name'          => __( 'Right Sidebar', 'mrwoocommerce' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'mrwoocommerce' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Shop Sidebar', 'mrwoocommerce' ),
				'id'            => 'shop-sidebar',
				'description'   => __( 'shop sidebar widget area', 'mrwoocommerce' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Left Sidebar', 'mrwoocommerce' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'mrwoocommerce' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Hero Slider', 'mrwoocommerce' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'mrwoocommerce' ),
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Hero Canvas', 'mrwoocommerce' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'mrwoocommerce' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Top Full', 'mrwoocommerce' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'mrwoocommerce' ),
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Footer Full', 'mrwoocommerce' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'mrwoocommerce' ),
